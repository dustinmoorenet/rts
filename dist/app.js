...
/***/ function(module, exports, __webpack_require__) {
	...
	global.store = (0, _configureStore2.default)({ debug: process.env.NODE_ENV === '' });
	
	global.store.dispatch((0, _actions.setRealTime)(Date.now()));
	global.store.dispatch((0, _actions.start)());
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./~/process/browser.js */ 1), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPlainObject = __webpack_require__(/*! lodash/isPlainObject */ 188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(/*! ./_getPrototype */ 189),
	    isHostObject = __webpack_require__(/*! ./_isHostObject */ 190),
	    isObjectLike = __webpack_require__(/*! ./isObjectLike */ 191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(/*! ./reducer */ 197);
	...
	function configureStore() {
	    ...
	    if (debug) {
	        finalCreateStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), (0, _redux.applyMiddleware)((0, _reduxLogger2.default)()))(_redux.createStore);
	    } else {
	        finalCreateStore = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default))(_redux.createStore);
	    }
	
	    return finalCreateStore(_reducer2.default, {});
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(/*! ./common/reducer */ 198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(/*! ./TimeMachine/reducer */ 199);
	...
	exports.default = (0, _redux.combineReducers)({
	    timeMachine: _reducer2.default
	});

/***/ },
/* 199 */
/*!**********************************************!*\
  !*** ./src/js/common/TimeMachine/reducer.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	function speed() {
	    ...
	    if (action.type === _actions.SET_SPEED) {
	...
	function time() {
	    ...
	    if (action.type === _actions.SET_TIME) {
	        return action.payload;
	    }
	...
	function realTime() {
	    ...
	    if (action.type === _actions.SET_REAL_TIME) {
	        return action.payload;
	    }
	...
	function stopBlock() {
	    ...
	    if (action.type === _actions.SET_STOP_BLOCK) {
	        return action.payload;
	    }
...
/* 200 */
/*!**********************************************!*\
  !*** ./src/js/common/TimeMachine/actions.js ***!
  \**********************************************/
/***/ function(module, exports) {
	...
	exports.setStopBlock = setStopBlock;
	exports.start = start;
	exports.stop = stop;
	exports.update = update;
	var BASE = exports.BASE = 'common/timeMachine';
	var SET_SPEED = exports.SET_SPEED = BASE + '/SET_SPEED';
	var SET_TIME = exports.SET_TIME = BASE + '/SET_TIME';
	var SET_REAL_TIME = exports.SET_REAL_TIME = BASE + '/SET_REAL_TIME';
	var SET_STOP_BLOCK = exports.SET_STOP_BLOCK = BASE + '/SET_STOP_BLOCK';
	var UPDATE_INTERVAL = exports.UPDATE_INTERVAL = 1000;
	...
	function setStopBlock(stopBlock) {
	    return {
	        type: SET_STOP_BLOCK,
	        payload: stopBlock
	    };
	...
	function stop() {
	    return function (dispatch) {
	        return dispatch(setStopBlock(true));
	    };
	}
	
	function update() {
	    return function (dispatch, getState) {
	        var _getState$common$time = getState().common.timeMachine;
	        var time = _getState$common$time.time;
	        var realTime = _getState$common$time.realTime;
	        var speed = _getState$common$time.speed;
	        var stopBlock = _getState$common$time.stopBlock;
	
	        var now = Date.now();
	        var lapse = now - realTime;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reselect = __webpack_require__(/*! reselect */ 202);
	...
	function Map(props) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('circle', { cx: cx, cy: cy, r: radius })
	    );
	}
	...
	var mapStateToProps = (0, _reselect.createStructuredSelector)({
	    radius: function radius(state) {
	        return state.common.timeMachine.time * 0.001;
	    },
	    cx: function cx(state) {
	        return state.common.timeMachine.time * 0.002;
	    },
	    cy: function cy(state) {
	        return state.common.timeMachine.time * 0.003;
	    }
	});
